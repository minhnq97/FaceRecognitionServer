...
{
    public class GoogleApiTokenVerifier
    {
        private const string CLIENT_ID = "636096643581-1s1gj0spot4b9dl3lgqe34m6piiv5mq6.apps.googleusercontent.com";
        private const string GOOGLE_API_TOKEN_VERIFIER_URL = "https://www.googleapis.com/oauth2/v3/tokeninfo?id_token={0}";
